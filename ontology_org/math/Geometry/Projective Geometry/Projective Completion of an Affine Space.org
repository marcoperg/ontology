:PROPERTIES:
:ID: 0B2DF1C9-251A-4569-A79D-E9E8B1765056
:END:
...
Lemma 5.8 [[file:Jean%20Gallier's%20_Geometry%20Methods%20and%20Applications_][1]]:

#+begin_html
  </ins>
#+end_html

Given a vector space \(E\) and a hyperplane \(H\) in \(E\), the complement \(E_H = \mathbf{P}(E) -\mathbf{P}(H\)) of the projective hyperplane \(\mathbf{P}(H)\) in the [[id:9543A33A-0CDB-4476-87ED-87F81C2C1AE5][projective space]] \(\mathbf{P}(E)\) can be given an affine structure such that the associated vector space of \(E_H\) is \(H\). The affine structure on \(E_H\) depends only on \(H\), and under this affine structure, \(E_H\) is isomorphic to an affine hyperplane in \(E\).
