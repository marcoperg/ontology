:PROPERTIES:
:ID: 30CCD29B-645D-460B-9FBB-14D5F3E20FB7
:END:
#+title: Desasgue's Theorem
...
#+caption: Desargues's theorem - Wikipedia
[[file:https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdwAprKNeBYczT_boES-M7kvz_FViPHEonMvcTWXD_cw&s.org][https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdwAprKNeBYczT_boES-M7kvz_FViPHEonMvcTWXD_cw&s]]

\(Pf:\)

In view of the assumptions of \(a, b, c, a', b', c'\), and \(d\): - the point \(r\) is on neither \(\langle a ,a' \rangle\) nor \(\langle b, b' \rangle\) - the point \(p\) is on neither \(\langle b ,b' \rangle\) nor \(\langle c, c' \rangle\) - the point \(q\) is on neither \(\langle a ,a' \rangle\) nor \(\langle c, c' \rangle\)
it is also immediately shown that the line \(\langle p, q \rangle\) is distinct from the lines \(A, B, C, A', B', C'\).

Let \(f: \langle a, a' \rangle \to \langle b, b'\rangle\) be the [[id:AFA50D2C-359C-4C21-B3A8-BB3BEEA0FC4E][perspectivity]] of center \(r\) and \(g: \langle b, b' \rangle \to \langle c, c'\rangle\) be the perspectivity of center \(p\).
